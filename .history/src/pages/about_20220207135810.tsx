     ...
     <div className={style.textArea}>
       <main className={style.hero}> 
        ...
        <h2>Maycon Goulart</h2>
         ...
         <p>    Desenvolvedor web e estudante do Curso de Engenharia da Computação. Tenho conhecimentos em React.js, Css, Html5, JavaScript, TypeScript e Node.js. 
