    ...
    <>
     <Head>
      ...
      <Container>
          ...
          <ConteinerCard onClick={()=> window.location.href='"https://github.com/Goulart94/", target="_blank" '}>
              
              <a href={} ><img src="../../imgs/github.png" alt='Git-profile'/></a><GoMarkGithub className='icon'/>
