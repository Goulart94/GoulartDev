...
import { AreaText, BoxMensange, ContainerText,  DadosContact,  Form } from './style';
    ...
    <AreaText>
         <ContainerText>
          ...
          <Form>
           ...
           <DadosContact type="fone" name="fone" placeholder='Digite seu Telefone' />
           <BoxMensange></BoxMensange>
          </Form>
