  ...
  return (
    <AreaText>
         <ContainerText>
           ...
           <p>ou</p>
           <section>
             <BsWhatsapp  className='iconSection' onClick={()=> window.open( "https://wa.me/351936353484")}></BsWhatsapp>
             <BsLinkedin className='iconSection' ></BsLinkedin>
             <BsGithub className='iconSection'></BsGithub>
           </section>
